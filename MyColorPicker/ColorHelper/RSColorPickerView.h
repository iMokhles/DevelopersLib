...
// - (void)setCropToCircle:(BOOL)circle quiet:(BOOL)quiet;

@property (nonatomic, strong) RSColorPickerState * state;

@property (nonatomic) NSString *hexValue;
// @property (nonatomic, assign) NSString *selectioColorKey;
// @property (nonatomic, assign) NSString *cropToCircleKey;
/**
