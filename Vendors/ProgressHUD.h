...
#define HUD_IMAGE_SUCCESS		[UIImage imageWithContentsOfFile:@"/Library/Application Support/DeveloperLib/DeveloperLib.bundle/progresshud-success.png"]
#define HUD_IMAGE_ERROR			[UIImage imageWithContentsOfFile:@"/Library/Application Support/DeveloperLib/DeveloperLib.bundle/progresshud-error.png"]
